...
void Fabrica::cargarContactos(){
        ...
        usuLog->altaPrecargaContacto(23654);
        //TANDA DE CONTACTOS 2
        usuLog->altaPrecargaContacto(65432);
        //TANDA DE CONTACTOS 3
        usuLog->altaPrecargaContacto(46810);
        //TANDA DE CONTACTOS 4
        usuLog->altaPrecargaContacto(66777);
    }
 ...
 //U1 90123654;
    ...
    //conv2 id=2
     ...
     /////////////////Mensaje1//////////////////////
        ...
        Usuario* u=cUsu->getUsuario(66777);//90666777
        u->setMensaje(men1,1);
        ...
        Usuario* u2=cUsu->getUsuario(66777); //90666777
   ...
   ////////////////////mensaje3//////////////////////     
        ...
        Usuario * u3=cUsu->getUsuario(23654);//90123654
    ...
    //////////////////mensaje4////////////////7    
        ...
        v->SetEstado(true);
        men4->SetVisto(v);
        v=new Visto(65432);//u2 90765432
        men4->SetVisto(v);
        v=new Visto(66777);//u4 90666777
        men4->SetVisto(v);      
        fecha=new DtFecha(22,5,2018);
        hora=new DtHora(18,13,0);
        men4->SetFechaEnv(fecha);
        men4->SetHoraEnv(hora);
        Usuario * u4= cUsu->getUsuario(46810); //90246810
    ...
    /////////////////mensaje5////////////////////    
        ...
        Usuario * u5= cUsu->getUsuario(65432); //90765432
    ...
    ///////////////mensaje6//////////////////////    
        ...
        Usuario * u6=cUsu->getUsuario(23654); //90123654
        ...
        Usuario * u7= cUsu->getUsuario(65432); //90765432
