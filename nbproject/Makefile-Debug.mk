...
${OBJECTDIR}/ColEstConv.o: ColEstConv.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ColEstConv.o ColEstConv.cpp

${OBJECTDIR}/ColMensaje.o: ColMensaje.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ColMensaje.o ColMensaje.cpp

${OBJECTDIR}/ColTipo.o: ColTipo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ColTipo.o ColTipo.cpp

${OBJECTDIR}/ColUsuPart.o: ColUsuPart.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ColUsuPart.o ColUsuPart.cpp

${OBJECTDIR}/ColUsuario.o: ColUsuario.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ColUsuario.o ColUsuario.cpp

${OBJECTDIR}/ColVisto.o: ColVisto.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ColVisto.o ColVisto.cpp
