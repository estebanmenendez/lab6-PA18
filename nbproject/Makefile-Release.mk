...
${OBJECTDIR}/DtMContacto.o: DtMContacto.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DtMContacto.o DtMContacto.cpp
...
${OBJECTDIR}/DtMultimedia.o: DtMultimedia.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DtMultimedia.o DtMultimedia.cpp
...
${OBJECTDIR}/DtVideo.o: DtVideo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DtVideo.o DtVideo.cpp
